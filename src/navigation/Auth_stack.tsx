...
import { Sign_up, Sign_in, OTP, ForgotPassword, CodeConfirmation, ResetPassword, Activate_account } from "../screens/Auth";
...
const Auth_stack = () => {
    return (
        <Stack.Navigator screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name={SCREEN_NAMES.Activate_account} component={Activate_account} />
        </Stack.Navigator>
    );
};
