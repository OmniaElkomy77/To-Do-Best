...
const AppInput = (props: ITextInput) => {
    const { placeholder, icon_name, onChangeText, value, secureTextEntry,
        errorMessage, error, onBlur, editable, settingEmailColor } = props

    const [showPassword, setShowPassword] = useState(false)
    return (
        <View >
            <View style={[styles.containerinputstyle, { backgroundColor: settingEmailColor ? themes.lightgrey : themes.white }]}>
