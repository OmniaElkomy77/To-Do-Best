const APIS = {
    ...
    dailyranktop5: "/api/user/rank/overAllTop",  //get
    appweekranktop5: "/api/user/rank/appWeekRankTop",//get
    weekranktop5: "/api/user/rank/weekRankTop",//get
    monthlyranktop5: "/api/user/rank/monthlyRankTop",//get
    dailyuserrank: "/api/user/rank/overAllUser",//get
    appweekuserrank: "/api/user/rank/appWeekRankUser",//get
    weekuserrank: "/api/user/rank/weekRankUser",//get
    monthlyuserrank: "/api/user/rank/monthlyRankUser",//get
    all_avatar: "/api/avatar",//get
    get_my_avatar: "/api/avatar/detail",//get
